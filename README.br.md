...
nix run nixpkgs#opencode           # ou github:liangboceo/opencode para a branch dev mais recente
```
...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/liangboceo/opencode/releases) ou em [opencode.ai/download](https://opencode.ai/download).
