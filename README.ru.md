...
nix run nixpkgs#opencode           # или github:liangboceo/opencode для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/liangboceo/opencode/releases) или с [opencode.ai/download](https://opencode.ai/download).
