...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/liangboceo/opencode/releases) eller [opencode.ai/download](https://opencode.ai/download).
