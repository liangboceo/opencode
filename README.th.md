...
<p align="center">
  ...
  <a href="https://github.com/liangboceo/opencode/actions/workflows/publish.yml"><img alt="สถานะการสร้าง" src="https://img.shields.io/github/actions/workflow/status/liangboceo/opencode/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
nix run nixpkgs#opencode           # หรือ github:liangboceo/opencode สำหรับสาขาพัฒนาล่าสุด
```
...
OpenCode มีให้ใช้งานเป็นแอปพลิเคชันเดสก์ท็อป ดาวน์โหลดโดยตรงจาก [หน้ารุ่น](https://github.com/liangboceo/opencode/releases) หรือ [opencode.ai/download](https://opencode.ai/download)
