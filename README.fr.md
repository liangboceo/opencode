...
nix run nixpkgs#opencode           # ou github:liangboceo/opencode pour la branche dev la plus récente
```
...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/liangboceo/opencode/releases) ou [opencode.ai/download](https://opencode.ai/download).
