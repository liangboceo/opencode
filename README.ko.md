...
nix run nixpkgs#opencode           # 또는 github:liangboceo/opencode 로 최신 dev 브랜치
```
...
OpenCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/liangboceo/opencode/releases) 에서 직접 다운로드하거나 [opencode.ai/download](https://opencode.ai/download) 를 이용하세요.
