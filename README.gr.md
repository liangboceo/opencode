...
nix run nixpkgs#opencode           # ή github:liangboceo/opencode με βάση την πιο πρόσφατη αλλαγή από το dev branch
```
...
Το OpenCode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/liangboceo/opencode/releases) ή το [opencode.ai/download](https://opencode.ai/download).
