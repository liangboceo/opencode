...
nix run nixpkgs#opencode           # veya en güncel geliştirme dalı için github:liangboceo/opencode
```
...
OpenCode ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/liangboceo/opencode/releases) veya [opencode.ai/download](https://opencode.ai/download) adresinden indirebilirsiniz.
