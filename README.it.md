...
<p align="center">
  ...
  <a href="https://github.com/liangboceo/opencode/actions/workflows/publish.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/liangboceo/opencode/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
nix run nixpkgs#opencode           # oppure github:liangboceo/opencode per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/liangboceo/opencode/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
