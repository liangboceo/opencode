...
nix run nixpkgs#opencode           # або github:liangboceo/opencode для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/liangboceo/opencode/releases) або [opencode.ai/download](https://opencode.ai/download).
