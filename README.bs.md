...
nix run nixpkgs#opencode           # ili github:liangboceo/opencode za najnoviji dev branch
```
...
OpenCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/liangboceo/opencode/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
