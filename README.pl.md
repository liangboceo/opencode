...
nix run nixpkgs#opencode           # lub github:liangboceo/opencode dla najnowszej gałęzi dev
```
...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/liangboceo/opencode/releases) lub z [opencode.ai/download](https://opencode.ai/download).
