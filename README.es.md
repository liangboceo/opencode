...
nix run nixpkgs#opencode           # o github:liangboceo/opencode para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/liangboceo/opencode/releases) o desde [opencode.ai/download](https://opencode.ai/download).
