    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/liangboceo/opencode/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/liangboceo/opencode/issues/new?template=bug_report.yml"),
