   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: liangboceo/opencode/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/liangboceo/opencode/issues.
