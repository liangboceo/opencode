...
nix run nixpkgs#opencode           # oder github:liangboceo/opencode für den neuesten dev-Branch
```
...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/liangboceo/opencode/releases) oder [opencode.ai/download](https://opencode.ai/download) herunter.
